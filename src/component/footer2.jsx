...
export default function Footer2() {
  return (
    <div>
      <div className="relative mt-20  " style={{ backgroundColor: "#009EFA" }}>
        <svg
        ...
        <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
            <div className="md:max-w-md lg:col-span-2">
              ...
              <span className="text-xl font-bold tracking-wide text-gray-100 uppercase text-left">
                Informatika 2023<br></br> Pre Intro To Technology
              </span>
            </div>
            <div className="grid grid-cols-2 row-gap-8 lg:col-span-4 md:grid-cols-3">
              <div>
                <p className="font-semibold tracking-wide text-sm text-deep-purple-50">
                  Created with
                </p>
                <ul className="mt-2 space-y-1 text-sm text-deep-purple-50">
                  <li className="flex">
                    <img
                      className="h-6 w-6"
              ...
              <div>
                ...
                <ul className="mt-2 space-y-2 text-sm text-deep-purple-50">
                  ...
                  <li className="flex pb-2 item-center justify-center">
                    <img
                      className="h-6 w-12"
                  ...
                  <li className="flex pb-2">
                    <img
                      className="h-8 w-12"
                      src="/images/svg/currencyapi.svg"
                      alt="Currency api"
                    />
                    <a
                      className="pb-2 pl-2"
                      href="https://app.currencyapi.com/login"
                    >
                      Currency Api
                    </a>
                  </li>
