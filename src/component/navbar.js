  ...
  return (
    <div>
      <div className=" grid w-full place-items-center rounded-lg lg:overflow-visible">
        <nav className=" sticky top-0 z-10 block w-full max-w-full mx-5 py-2 text-white border rounded-none shadow-md h-max border-white/80 bg-opacity-80 lg:px-12 lg:py-4 bg-white">
        ...
        {burgerOpen && (
          <div class="absolute z-[800]  top-24 flex h-[calc(100vh-2rem)] w-full flex-col  bg-white bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5">
