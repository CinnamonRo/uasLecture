  ...
  return (
    <div>
      ...
      >
        ...
        <Explore
          imgSrc={dataExplore[17][0].imgSrc}
          type={dataExplore[17][0].type}
          rating={dataExplore[17][0].rating}
          review={dataExplore[17][0].review}
          lokasi={dataExplore[17][0].lokasi}
          place={dataExplore[17][0].place}
          content={dataExplore[17][0].content}
          price={dataExplore[17][0].price}
        />
        <Explore
          imgSrc={dataExplore[17][1].imgSrc}
          type={dataExplore[17][1].type}
          rating={dataExplore[17][1].rating}
          review={dataExplore[17][1].review}
          lokasi={dataExplore[17][1].lokasi}
          place={dataExplore[17][1].place}
          content={dataExplore[17][1].content}
          price={dataExplore[17][1].price}
        />
        <Explore
          imgSrc={dataExplore[17][2].imgSrc}
          type={dataExplore[17][2].type}
          rating={dataExplore[17][2].rating}
          review={dataExplore[17][2].review}
          lokasi={dataExplore[17][2].lokasi}
          place={dataExplore[17][2].place}
          content={dataExplore[17][2].content}
          price={dataExplore[17][2].price}
        />
        <Explore
          imgSrc={dataExplore[17][3].imgSrc}
          type={dataExplore[17][3].type}
          rating={dataExplore[17][3].rating}
          review={dataExplore[17][3].review}
          lokasi={dataExplore[17][3].lokasi}
          place={dataExplore[17][3].place}
          content={dataExplore[17][3].content}
          price={dataExplore[17][3].price}
        />
      </div>
