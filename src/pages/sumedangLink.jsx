  ...
  return (
    <div>
      ...
      >
        ...
        <Explore
          imgSrc={dataExplore[19][0].imgSrc}
          type={dataExplore[19][0].type}
          rating={dataExplore[19][0].rating}
          review={dataExplore[19][0].review}
          lokasi={dataExplore[19][0].lokasi}
          place={dataExplore[19][0].place}
          content={dataExplore[19][0].content}
          price={dataExplore[19][0].price}
        />
        <Explore
          imgSrc={dataExplore[19][1].imgSrc}
          type={dataExplore[19][1].type}
          rating={dataExplore[19][1].rating}
          review={dataExplore[19][1].review}
          lokasi={dataExplore[19][1].lokasi}
          place={dataExplore[19][1].place}
          content={dataExplore[19][1].content}
          price={dataExplore[19][1].price}
        />
        <Explore
          imgSrc={dataExplore[19][2].imgSrc}
          type={dataExplore[19][2].type}
          rating={dataExplore[19][2].rating}
          review={dataExplore[19][2].review}
          lokasi={dataExplore[19][2].lokasi}
          place={dataExplore[19][2].place}
          content={dataExplore[19][2].content}
          price={dataExplore[19][2].price}
        />
        <Explore
          imgSrc={dataExplore[19][3].imgSrc}
          type={dataExplore[19][3].type}
          rating={dataExplore[19][3].rating}
          review={dataExplore[19][3].review}
          lokasi={dataExplore[19][3].lokasi}
          place={dataExplore[19][3].place}
          content={dataExplore[19][3].content}
          price={dataExplore[19][3].price}
        />
      </div>
